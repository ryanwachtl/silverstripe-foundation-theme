<div class="<% if $Children || $Parent %>large-9 large-push-3<% else %>large-12<% end_if %> columns">
	...
	<ul class="small-block-grid-2 large-block-grid-4">
		...
		<li><img class="th" src="$ThemeDir/images/examples/spacewalk-th.jpg"></li>
	</ul>
	...
	<div>
		<ul class="clearing-thumbs" data-clearing>
			<li><a class="th" href="$ThemeDir/images/examples/comet.jpg"><img data-caption="Nulla vitae elit libero, a pharetra augue. Cras mattis consectetur purus sit amet fermentum." src="$ThemeDir/images/examples/comet-th-sm.jpg"></a></li>

			<li><a class="th" href="$ThemeDir/images/examples/earth.jpg"><img src="$ThemeDir/images/examples/earth-th-sm.jpg"></a></li>

			<li><a class="th" href="$ThemeDir/images/examples/launch.jpg"><img data-caption="Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus." src="$ThemeDir/images/examples/launch-th-sm.jpg"></a></li>

			<li><a class="th" href="$ThemeDir/images/examples/satelite.jpg"><img src="$ThemeDir/images/examples/satelite-th-sm.jpg"></a></li>

			<li><a class="th" href="$ThemeDir/images/examples/space.jpg"><img data-caption="Integer posuere erat a ante venenatis dapibus posuere velit aliquet." src="$ThemeDir/images/examples/space-th-sm.jpg"></a></li>
		</ul>
	</div>
	...
	think is awesome! Some text that people will think is awesome!</p>
		<img src="$ThemeDir/images/examples/launch.jpg">
	...
	<p><h5>h5. This is a small header. h1.</h5></p>
